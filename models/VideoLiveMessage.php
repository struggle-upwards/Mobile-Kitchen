...
class VideoLiveMessage extends BaseModel{
    ...
    public function tableName() {
        return '{{video_live_realtime_interaction_message}}';
    }
    ...
    public function relations() {
        return array(
            ...
            'gf_s_gfid' => array(self::BELONGS_TO,'userlist','s_gfid'),
            'gf_live_reward_gfid' => array(self::BELONGS_TO,'userlist','live_reward_gfid'),
            'video_live_id' => array(self::BELONGS_TO,'VideoLive','live_id'),
            'programs' => array(self::BELONGS_TO, 'VideoLivePrograms', 'live_program_id'),
            'gf_r_gfid' => array(self::BELONGS_TO,'userlist','r_gfid'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            's_gfid' => '发送者',  // user_type==1为userlist表id，user_type=2为qmdd_adminstrtors表id',
