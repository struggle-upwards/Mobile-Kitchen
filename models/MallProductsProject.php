...
class MallProductsProject extends BaseModel {

    public function tableName() {
        return '{{mall_products_project}}';
    }
    ...
    public function rules() {
        return array(
            array('mall_products_id', 'required', 'message' => '{attribute} 不能为空'),
            array('project_id', 'required', 'message' => '{attribute} 不能为空'),
            array('mall_products_id, project_id', 'numerical', 'integerOnly' => true),
