...
//			console.log("The client connect success.");
		...
		onFailure : function(err) {
			alert("The client connect failure abc1234" + err.errorMessage);  
...
//桌面提示
function notify(msg) {
    showMsgNotification('新消息', msg, ctx+"resources/images/home2_a1_1230_r1_c7.png");
}
var timer = null,
title = $('title').text();
function showMsgNotification(title, msg, icon) {
    var options = {
        body: msg,
        icon: icon || ctx+"resources/images/home2_a1_1230_r1_c7.png"
    };
