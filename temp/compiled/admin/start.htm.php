...
<ul style="padding:0; margin: 0; list-style-type:none; color: #CC0000;">
 <!-- <script type="text/javascript" src="https://qmdd.gf41.net/notice.php?v=1&n=8&f=ul"></script>-->
</ul>
...
<table cellspacing='1' cellpadding='3'>
  ...
  <tr>
    <td>{//$lang.spt_version}</td>
    <td>{//$spt_version} RELEASE <?php echo $this->_var['ecs_release']; ?></td>
    <td>{//$lang.install_date}</td>
    <td>{//$install_date}</td>
  </tr>
  <tr>
    <td>{//$lang.SP_CHARSET}</td>
    <td>{//$ecs_charset}</td>
    <td></td>
    <td></td>
  </tr>
