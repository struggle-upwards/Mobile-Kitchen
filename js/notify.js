...
//			console.log("The client connect success.");
		...
		onFailure : function(err) {
			alert("The client connect failure abc235" + err.errorMessage);  
...
Websocket.prototype.subscribe = function() {
	...
	if (!_this.vmWS.data.subInfo.topic) {
		console.log('Please fill in the topic.');
...
Websocket.prototype.sendMessage = function(array) {
	var _this = this;
	// if (!_this.client || !_this.client.isConnected()) {
		// alert('The client does not connect to the broker');
		// return;
...
//桌面提示
function notify(msg) {
    showMsgNotification('新消息', msg, "images/home2_a1_1230_r1_c7.png");
}
var timer = null,
title = $('title').text();
function showMsgNotification(title, msg, icon) {
    var options = {
        body: msg,
        icon: icon || "images/home2_a1_1230_r1_c7.png"
    };
