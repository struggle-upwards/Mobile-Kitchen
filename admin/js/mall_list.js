...
/*-------商品数量-添加行-----------------*/
function add_numline(){
    var str = "mall_num_list_" + randSourceListNum ;
    $('#mall_num_source_div').append('<span><br />最低数量 <input type="text" name="'+str+'_min" size="20" /> 件，最高数量 <input type="text" name="'+str+'_mAX" size="20" /> 件&nbsp;<input type="button" class="mall_btn" name="'+str+'_del" value="删除" onclick="delRankSource(this)"/></span>');
    randSourceListNum++;
}
/*-------订单价格-添加行-----------------*/
function add_price_line(){
    var str = "mall_price_list_" + randSourceListNum ;
    $('#mall_price_source_div').append('<span><br />最低总价 <input type="text" name="'+str+'_min" size="20" /> 元，最高总价 <input type="text" name="'+str+'_mAX" size="20" /> 元&nbsp;<input type="button" class="mall_btn" name="'+str+'_del" value="删除" onclick="delRankSource(this)"/></span>');
    randSourceListNum++;
}
/*-------区域免邮-添加行-----------------*/
