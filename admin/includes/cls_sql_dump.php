...
class cls_sql_dump
{
    ...
    function get_table_df($table, $add_drop = false)
    {
        ...
        {
            $table_df .= $tmp_sql . " ENGINE=MyISAM DEFAULT CHARSET=" . str_replace('-', '', SP_CHARSET) . ";\r\n";
        }
        else
        {
    ...
    function dump_table($path, $vol)
    {
        ...
        $this->dump_sql .= '-- END Qmddshop v2.x SQL Dump Program ';
