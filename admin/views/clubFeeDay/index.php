<div class="box">
    ...
    <div class="box-title c"><h1>当前界面：会员 》会员设置 》收费有效期设置</h1></div>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;"><?php echo $model->getAttributeLabel('f_day');?></th>
...
?>
                    <tr>
                        ...
                        <td style="text-align: center"><?php echo $v->f_day; ?></td>
