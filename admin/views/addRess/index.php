<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>地址列表</h1></div><!--box-title end-->
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $model->getAttributeLabel('province');?></th>
                        <th><?php echo $model->getAttributeLabel('city');?></th>
                        <th><?php echo $model->getAttributeLabel('district');?></th>
                        <th><?php echo $model->getAttributeLabel('ads_detail');?></th>
...
$index = 1;
 foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td><?php echo $v->ads_detail; ?></td>
                        <td><?php echo $v->isDefault; ?></td>
