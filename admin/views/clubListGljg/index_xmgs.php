<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：首页》管理机构》项目公司</span> </h1>
    ...
    <div class="box-content">
        <div class="box-table">
            <table class="list" style="text-align:left;">
                <thead>
                    <tr>
                        <th class="check"><input id="j-checkall" claeck" type="checkbox"></th>
                        <th>序号</th>
                        <th><?php echo $model->getAttributeLabel('club_code'); ?></th>
                        <th style="width:150px"><?php echo $model->getAttributeLabel('company'); ?></th>
                        <th>机构类型</th>
                        <th>开通项目</th>
                        <th>项目名称</th>
                ...
                <?php $index = 1;foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td><?php echo ClubProject::model()->count('club_id=' . $v->id . ' and project_state=506 and auth_state=461 and state=2') ?></td>
                        <?php
                            $Project_array = ClubProject::model()->findAll('club_id=' . $v->id . ' and project_state=506 and auth_state=461 and state=2');
                            $tx = '';
                        ...
                        <td >
                            <?php echo show_command('详情',$this->createUrl('update', array('id'=>$v->id,'action'=>'index_xmgs'))); ?>
                        </td>
                    </tr>
                    <?php $index++; } ?>
                </tbody>
