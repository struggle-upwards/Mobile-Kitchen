<div class="box">
    <div class="box-title c">
        <h1>当前界面：培训/活动》活动发布》<a class="nav-a">活动审核</a></h1>
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>关键字：</span>
                    <input style="width:200px;" class="input-text" placeholder="活动编号 / 活动标题" type="text" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords');?>">
                </label>
...
<?php foreach($arclist as $v){ ?>
                    <tr id="hidden_<?php echo $v->id?>">
                        ...
                        <td>
                    <a class="btn" href="<?php echo $this->createUrl('Updatecheck', array('id'=>$v->id));?>" title="审核">审核</a>
