...
<div class="box">
    ...
    <h1>当前界面：订宴管理》上架管理》<a class="nav-a">
        宴席上架调整</a></h1>
    ...
    <div class="box-content">
        ...
        <div class="box-table">
           ...
           <td><?php echo $v->meal_name; ?></td>
            ...
            <td><?php echo $v->onsale?'是':'否'; ?></td>
            <td  style="text-align:center">  
                <a class="btn" href="<?php echo $this->createUrl('updatesee', array('id'=>$v->id));?>" title="编辑"><i class="fa fa-edit"></i>查看</a>
                <a class="btn" href="<?php echo $this->createUrl('UpdateIndexsale', array('id'=>$v->id));?>" onclick="confirmChange()" title="编辑"><i class="fa fa-edit"></i>上下架切换</a>
            </td>
            </tr>
                   <?php } ?>
                </table>
