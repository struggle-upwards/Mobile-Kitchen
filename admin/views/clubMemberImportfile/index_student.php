...
<div class="box">
    ...
    <div class="box-title c"><h1>当前界面：会员 》会员管理 》会员导入</h1></div><!--box-title end-->
...
<script>
    ...
    function importfile() {
        $.dialog.open('<?php echo $this->createUrl("clubMemberList/upExcel"); ?>', {
            id: 'sensitive',
            lock: true,
            opacity: 0.3,
            title: '导入会员信息',
    ...
    function confirmed(id){
        ...
        // $.ajax({
        //     type:'post',
        //     url:'<?php echo $this->createUrl('confirmednew'); ?>&id='+id,
        //     // data:{id:id},
        //     dataType:'json',
        ...
        $.ajax({ 
        type: 'get',
        url: '<?php echo $this->createUrl('ClubMemberImportfile/confirmednew'); ?>',
        data: {ID:id,
        },
        dataType:'json',
        success: function(data) {
