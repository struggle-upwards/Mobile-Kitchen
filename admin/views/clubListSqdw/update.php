<div class="box">
    ...
    <div class="box-title c">
        <?php if($sign == 'create'){?>
            <h1>当前界面：单位》单位管理》单位入驻》<a class="nav-a">添加</a></h1>
        <?php }?>
        <?php if($sign == 'update'){?>
            <h1>当前界面：单位》单位管理》单位入驻》<a class="nav-a">编辑</a></h1>
        <?php }?>
        <?php if($sign == 'index_pass'){?>
            <h1>当前界面：单位》单位管理》单位列表》<a class="nav-a">编辑</a></h1>
        <?php }?>
    ...
    <div class="box-detail-bd">
            <table>
                ...
                <tr class="table-title">
                    <td colspan="4" style="font-size: 15px;font-weight: bold;">单位基本信息</td>
                </tr>
