<div class="box">
    <div class="box-title c">
        <h1>当前界面：单位》单位管理》<a class="nav-a">单位入驻</a></h1>
...
<script>
    var deleteUrl = '<?php echo $this->createUrl('ClubListSqdw/Delete', array('id'=>'ID'));?>';
</script>
<script>
    function tijiao(modelid) {
        $.ajax({
            type: 'get',
            url: "<?php echo $this->createUrl('ClubListSqdw/Tijiao');?>",
            data: {
                modelid:modelid
            },
            dataType: 'json',
