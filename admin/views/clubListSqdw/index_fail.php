<div class="box">
    <div class="box-title c">
        <h1>当前界面：社区单位》社区管理》<a class="nav-a">审核未通过列表</a></h1>
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>关键字：</span>
                    <input style="width:200px;" class="input-text" placeholder="社区编号 / 社区名称" type="text" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords');?>">
                </label>
