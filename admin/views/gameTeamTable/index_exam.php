...
<div class="box">
    ...
    <div class="box-content">
        <div class="box-header">
            <a href="<?php echo $this->createUrl('gameSignList/to_audited'); ?>" style="border:solid 1px #ccc;padding:5px;"><span>待审核：<span class="red"><?php echo $count1+$count2; ?></span></span></a>
        </div>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('sign_game_data_name');?></th>
                ...
                <tbody>
                <?php $index = 1; foreach($arclist as $v){ $pid = ($v->state==721) ? 1 : 0; ?>
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <?php
                                if(!empty($v->sign_game_data_id) && !empty($v->game_list_data)) echo $v->game_list_data->game_player_team_name;
                            ?>
                        </td>
                        <td style="text-align: center;"><?php echo $v->create_account; ?></td>
                        <td style="text-align: center;">
                            <?php
                                if(!empty($v->game_list_data) && $v->game_list_data->game_player_team!=666){
