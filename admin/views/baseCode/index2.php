<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>公共部二级类型</h1></div>
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('create', array('id'=>$_GET['id']));?>"><i class="fa fa-plus"></i>添加</a>
            <a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a>
            <span class="back" style="float:right"><a href="javascript:;" class="btn" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span>
        </div><!--box-header end-->
...
<script>
    var deleteUrl = '<?php echo $this->createUrl('delete', array('id'=>'f_id'));?>';
</script>