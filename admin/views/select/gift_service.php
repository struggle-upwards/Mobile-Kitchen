...
<?php foreach($arclist as $v){ ?>
                    ...
                    <tr style="display:none;" class="item item_<?php echo $v->id; ?>" data-id="<?php echo $v2->id; ?>" data-title="<?php echo $v->select_title; ?>" data-ico="<?php if($v->select_item1!=''){ echo $wwwpath; } ?><?php echo $v->select_item1; ?>" data-json-attr="<?php echo $v2->service_datatime_start; ?>至<?php echo $v2->service_datatime_end; ?>">
                        <td><?php echo $v2->service_datatime_start; ?>至<?php echo $v2->service_datatime_end; ?></td>
                    </tr>
                    <?php }?>
                    <?php }?>
<?php } ?>
