...
<?php foreach($arclist as $v){ ?>
                    <tr id="line<?php echo $v->id; ?>" data-id="<?php echo $v->id; ?>" data-code="<?php echo $v->news_code; ?>" data-title="<?php echo $v->news_title; ?>">
                        ...
                        <td width="30%"><?php echo $v->news_code; ?></td>
                        <td width="60%"><?php echo $v->news_title; ?></td>
                    </tr>
<?php } ?>
                </tbody>
            </table>
