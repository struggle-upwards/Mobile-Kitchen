...
<?php foreach($arclist as $v){ ?>
                    ...
                    <tr style="display:none;" class="item item_<?php echo $v->id; ?>" data-id="<?php echo $v->id; ?>" data-name="<?php echo $v->title; ?>" data-code="<?php echo $v->service_code; ?>" data-attrid="<?php echo $v2->id; ?>" data-attr="<?php echo $v2->service_date; ?> <?php echo $v2->service_datatime_start;?>-<?php echo $v2->service_datatime_end;?>">
