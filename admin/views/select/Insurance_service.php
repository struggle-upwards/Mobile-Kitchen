        ...
        <div>
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>关键字：</span>
                    <input id="service" style="width:200px;" class="input-text" type="text" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords');?>">
                </label>
...
$(function(){
    ...
    $('.box-table tbody tr').on('click', function(){
        $.dialog.data('service_id', $(this).attr('data-id'));
        $.dialog.data('service_name', $(this).attr('data-title'));
        $.dialog.close();
    });
});
</script>