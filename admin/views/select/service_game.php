...
<?php foreach($arclist as $v){ ?>
                    <tr class="list-open product_ul" id="product_<?php echo $v->id; ?>" data-id="<?php echo $v->id; ?>" data-name="<?php echo $v->game_title; ?>" data-code="<?php echo $v->game_code; ?>">
                        <td class="first"><?php echo $v->game_title; ?></td>
                    </tr>
                    <?php if(isset($v->game_list_data) && !empty($v->game_list_data)){?>
                    <?php foreach($v->game_list_data as $v2){?>
                    <tr style="display:none;" class="item item_<?php echo $v->id; ?>" data-id="<?php echo $v->id; ?>" data-name="<?php echo $v->game_title; ?>" data-code="<?php echo $v->game_code; ?>" data-attrid="<?php echo $v2->id; ?>" data-attr="<?php echo $v2->game_data_name; ?>">
                        <td><?php echo $v2->game_data_name; ?></td>
                    </tr>
                    <?php }?>
                    <?php }?>
<?php } ?>
