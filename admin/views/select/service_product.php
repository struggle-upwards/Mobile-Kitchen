...
<?php foreach($arclist as $v){ ?>
                    ...
                    <tr style="display:none;" class="item item_<?php echo $v->id; ?>" data-id="<?php echo $v->id; ?>" data-name="<?php echo $v->name; ?>" data-code="<?php echo $v2->code; ?>" data-attrid="<?php echo $v2->id; ?>" data-attr="<?php echo $v2->json_attr; ?>">
