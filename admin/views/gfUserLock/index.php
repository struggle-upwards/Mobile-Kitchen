<div class="box">
    ...
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="index?r=gfUserLock/create&action=index">冻结</a>
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>申请日期：</span>
                    <input style="width:100px;" class="input-text" type="text" id="start_date" name="start_date" value="<?php ?>">
                    <span>-</span>
                    <input style="width:100px;" class="input-text" type="text" id="end_date" name="end_date" value="<?php ?>">
                </label>
                <label style="margin-right:10px;">
                    <!--<span>关键字：</span>-->
            ...
            <table class="list" style="text-align:left;">
                <thead>
                    ...
                    <th class="check"><input id="j-checkall" class="input-check" type="checkbox"></th>
                        ...
                        <th width="10.7%"><?php echo $model->getAttributeLabel('admin_gfname'); ?></th>
                        <th width="10.7%">操作</th>
...
?>
                    ...
                    <td class="check check-item"><input class="input-check" type="checkbox" value="<?php echo CHtml::encode($v->GF_ID); ?>"></td>
                        ...
                        <td>
                            <?php
                                echo show_command('详情',$this->createUrl('update', array('id'=>$v->ID, 'action'=>'index'))).'&nbsp;&nbsp;';
                                if($v->state == 371) {
