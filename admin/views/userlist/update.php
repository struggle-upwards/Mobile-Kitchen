		...
		<?php $form = $this->beginWidget('CActiveForm', get_form_list()); ?>
            <table style="table-layout:auto;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="upload_img fl" id="upload_pic_userlist_imgUrl">
            ...
            <!-- <table class="mt15" style="table-layout:auto;"> -->
                ...
                <tr>
                    ...
                    <td><?php if(!empty($model->id_card))echo substr_replace($model->id_card, '****',3, -4); ?></td>
                </tr>
                <?php } ?>
                <!-- 用户角色 -->
                <tr>
            ...
            <table width="100%" class="mt15" style="table-layout:auto;">
                ...
                <tr>
                    <td>操作</td>
                    <td>
                        <a class="btn btn-blue" href="<?php echo $this->createUrl('updateRole',array('id'=>$model->GF_ID)); ?>" ><i class="fa fa-plus"></i>新增角色</a>
                    </td>
                </tr>
            </table>
            <?php } ?>
