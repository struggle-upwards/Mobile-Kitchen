<div class="box">
    <div class="box-title c">
        <h1> <span>当前界面：供应商》供应商认证》认证待审核</span> </h1>
                        ...
                        <td>
                            <?php 
                                if(!empty($v->edit_state)&&$v->edit_state==1538){
                                    echo show_command('修改',$this->createUrl('update_data', array('id'=>$v->id,'action'=>'index_prove_wait_exam')));
                                }else{
                                    echo show_command('详情',$this->createUrl('update_data', array('id'=>$v->id,'action'=>'index_prove_wait_exam'))); 
                                }
                            ?>
                            <?php 
                                if($v->edit_state!=371){
