<div class="box">
    ...
    <div class="box-content">
    	<div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('create', array('action'=>'add'));?>"><i class="fa fa-plus"></i>添加</a>
...
<?php if (is_array($arclist)) foreach($arclist as $v){ ?>
    <tr>
        ...
        <td>
        <?php if($v->state == 721 || $v->state == 373){?>
         <a class="btn" href="<?php echo $this->createUrl('update', array('id'=>$v->id,'action'=>'edit'));?>" title="编辑">编辑</a>
...
<script>
var deleteUrl = '<?php echo $this->createUrl('delete2', array('id'=>'ID'));?>';
</script>
<script>
$(function(){
