<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>添加广告位置</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
    ...
    <?php  $form = $this->beginWidget('CActiveForm', get_form_list()); ?>
        <table>
            ...
            <tr>
                ...
                <td>
                    <?php echo $form->textField($model, 'how_long_dispay', array('class' => 'input-text', 'style'=>'width:100px;')); ?>
                    <span>秒</span>
            ...
            <tr>
                ...
                <td colspan="3">
                    <?php echo $form->textField($model, 'dispay_num', array('class' => 'input-text', 'style'=>'width:100px;')); ?>
            ...
            <!--tr>
                ...
                <td colspan="3">
                    ...
                    <table class="showinfo">
                        <tr>
                            <th width="15%">商品货号</th>
                            <td width="35%" id="product_code"></td>
                            <th width="15%">商品名称</th>
                            <td width="35%" id="product_name"></td>
                        </tr>
                        <tr>
                            <th>商品属性</th>
                            <td id="product_attr"></td>
                            <th>价格</th>
