...
$index = 1;
 foreach($arclist as $v){ ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn" href="<?php echo $this->createUrl('beansHistory/index',array('pid' => $v->id));?>" title="体育豆详细记录">体育豆详细</a>
                            <a class="btn" href="<?php echo $this->createUrl('gfCreditHistory/index',array('pid' => $v->id));?>" title="积分详细记录">积分详细</a>
